"""Local whitelist comparison with sanitized reference fixtures."""
import json
...
OUT=Path('visual-baseline/fixtures/whitelist')
...
with sync_playwright() as p:
    ...
    def fixture(route):
        ...
        route.fulfill(json={'items':rows,'total':3} if path=='risk/whitelist' else {'items':[],'total':0})
