        ...
        table: {
            first: function () {
                ...
                table1.bootstrapTable({
                    url: 'users/lottery/index/user_id/' + user_id,
                    toolbar: '#toolbar1',
                    sortName: 'id',
                    search: false,
                    columns: [
                        [
							...
							{field: 'user_id', title: '会员ID', operate: false},
            ...
            second: function () {
                ...
                table2.bootstrapTable({
                    url: 'users/risk/index/user_id/' + user_id,
                    toolbar: '#toolbar2',
                    sortName: 'id',
                    search: false,
                    columns: [
			...
			third: function () {
                ...
                table3.bootstrapTable({
                    url: 'users/coinday/index/user_id/' + user_id,
                    toolbar: '#toolbar3',
                    sortName: 'id',
                    search: false,
                    columns: [
			...
			four: function () {
                ...
                table4.bootstrapTable({
                    url: 'users/coinlog/index/user_id/' + user_id,
                    toolbar: '#toolbar4',
                    sortName: 'id',
                    search: false,
                    columns: [
			...
			five: function () {
                ...
                table5.bootstrapTable({
                    url: 'users/exchange/index/user_id/' + user_id,
					extend: {
			...
			six: function () {
                ...
                table6.bootstrapTable({
                    url: 'users/distribution/index/user_id/' + user_id,
                    toolbar: '#toolbar6',
                    sortName: 'id',
                    search: false,
                    columns: [
			...
			seven: function () {
                ...
                table7.bootstrapTable({
                    url: 'users/loginlog/index/user_id/' + user_id,
                    toolbar: '#toolbar7',
                    sortName: 'id',
                    search: false,
                    columns: [
			...
			eight: function () {
                ...
                table8.bootstrapTable({
                    url: 'users/address/index/user_id/' + user_id,
                    toolbar: '#toolbar8',
                    sortName: 'id',
                    search: false,
                    columns: [
